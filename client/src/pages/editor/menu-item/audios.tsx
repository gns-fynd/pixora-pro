...
export const Audios = () => {
  ...
  const uploadedAudios = getUploadedFilesByType('audio') as Partial<IAudio>[];
    ...
    <div className="flex flex-1 flex-col">
      ...
      <ScrollArea>
        <div className="flex flex-col px-2">
          ...
          {/* Stock audios */}
          <div className="mt-4 mb-1 px-2 text-xs font-medium text-muted-foreground">
            Stock Audio
          </div>
