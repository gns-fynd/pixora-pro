...
class ChatAgent:
    ...
    def __init__(self):
        ...
        self.conversations: Dict[str, List[Message]] = {}  # Store conversations by user_id
    ...
    async def process_message(self, user_id: str, content: str, task_id: Optional[str] = None) -> Dict[str, Any]:
        """
        ...
        self.add_message(user_id, Message(role="user", content=content))
        ...
        self.add_message(user_id, assistant_message)
        ...
        if hasattr(message, 'tool_calls') and message.tool_calls:
            ...
            for tool_call in message.tool_calls:
                ...
                self.add_message(user_id, function_message)
            ...
            self.add_message(user_id, follow_up)
    ...
    async def _call_function(self, function_name: str, args: Dict[str, Any]) -> Any:
        ...
        function_map = {
            ...
            "create_scene_video_with_motion": create_scene_video_with_motion,
